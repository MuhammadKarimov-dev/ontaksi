"""
Django settings for taxi_site project.
...
ALLOWED_HOSTS = ['176.53.160.181', 'ontaksi.uz']
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'announcement.context_processors.admin_contacts',
            ],
        },
    },
]

from .config_data import admin,admin_phone
